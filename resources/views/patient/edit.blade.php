    ...
    <form action="{{ route('patients.update', ['patient' => $patient->id]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <p class="mt-1 text-sm leading-6 text-gray-600">This information will be displayed to doctors so be careful
                    what you share.</p>
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <textarea id="illness" name="illness" rows="3"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                {{ $patient->illness }}
              </textarea>
                        </div>
                    ...
                    <div class="col-span-full">
                        <div class="col-span-full">
                            <label for="cover-photo" class="block text-sm font-medium leading-6 text-gray-900">Uploaded
                                file</label>
                            <div
                        ...
                        <label for="file" class="block text-sm font-medium leading-6 text-gray-900">Upload Different
                            file</label>
                        ...
                        <label for="file"
                            ...
                            <input
                                ...
                                aria-describedby="file_input_help" name='file' id="file" type="file">
