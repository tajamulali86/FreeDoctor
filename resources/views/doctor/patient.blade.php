...
@section('content')
        ...
        <div class="border-b border-gray-900/10 pb-12">
            ...
            <div class=" grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-6">
                <div class="sm:col-span-2 sm:col-start-1">
                    ...
                    <div class="mt-2">
                        <input type="text" name="city" id="city" value="{{ $patient->user->name }}"
                ...
                <div class="sm:col-span-2 ">
                    ...
                    <div class="mt-2">
                        <input type="text" name="city" id="city" value="{{ $patient->user->email }}"
                            autocomplete="address-level2" disabled
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="sm:col-span-2 sm:col-start-1">
                    ...
                    <div class="mt-2">
                        <input type="text" name="city" id="city" value="{{ $patient->number }}"
                            autocomplete="address-level2" disabled
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-2">
                        <input type="text" name="region" id="region" value="{{ $patient->age }}"
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-6">
                ...
                <div class="col-span-full">
                    <label for="street-address" class="block text-sm font-medium leading text-gray-900">Street
                        address</label>
                    <div class="mt-2">
                        <input type="text" name="street-address" id="street-address" value="{{ $patient->Address }}"
                ...
                <div class="col-span-full">
                    ...
                    <div class="mt-2">
                        <textarea id="about" name="about" rows="3" disabled
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"> {{ $patient->illness }}"</textarea>
                    </div>
                ...
                <div class="">
                    ...
                    <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 ">
                        <a target="_blank" href="{{ asset('/storage/' . $patient->file_path) }}"> <svg
    ...
    <form method="post" action="{{ route('comments.store') }}"  enctype="multipart/form-data">
        ...
        <div class="form-group w-full">
            <textarea class="form-control mt-2  w-1/2 flex justify-center rounded-lg border border-dashed border-gray-900/25"
                name="body"></textarea>
